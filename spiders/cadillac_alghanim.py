...
class CadillacAlghanimSpider(scrapy.Spider):
    name = "cadillac_alghanim"
    allowed_domains = []
    urls = []
    start_urls = ["https://www.cadillacalghanim.com/vehicles/cadillac-certified-vehicles/"]
    
    
    
    def parse(self,response):
        for href in response.xpath("//div[contains(@class, 'title module')]/h3/a//@href"):
            url="https://www.cadillacalghanim.com"+href.extract()
    ...
    def parse_dir_contents(self,response):
        ...
        item2['src'] = "cadillacalghanim.com"
        item2['ts'] = datetime.utcnow().isoformat()
        item2['name'] = "cadillac_alghanim"
        ...
        item['Seller_Name'] = 'Cadillac Alghanim'
