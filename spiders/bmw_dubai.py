...
class BmwDubaiSpider(scrapy.Spider):
    name = "bmw_dubai"
    allowed_domains = []
    urls = []
    start_urls = ["https://www.bmw-dubai.com/en_AE/local-content/pre-owened-vehicles/introduction/_jcr_content/par/iframeadaptive.integration-iframe.json"]

    def parse(self,response):
        body = json.loads(response.body)
        for i in range(2):
            url = "https://bps.bmw.com/AE/en_AE/000415-dg"+"/search?q=:relevance&page=" + str(i)
