...
class GmcUmaSpider(scrapy.Spider):
    name = 'gmc_uma'
    allowed_domains = []
    start_urls = ["https://gmc.uma.com.sa/pre-owned-vehicles/"]
    ...
    def parse(self, response):
        ...
        for url in path:
            ...
            url_det = ('https://gmc.uma.com.sa'+ ''.join(url_details)).strip()
        ...
        if nex != '':
            url = 'https://gmc.uma.com.sa/pre-owned-vehicles/' + nex
