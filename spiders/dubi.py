...
class DubiSpider(scrapy.Spider):
    name = 'dubi'
    allowed_domains = []
    start_urls = ['https://www.dubicars.com/dubai-111-used-cars-123?view=grid&o=&dealerlayout=&dealer_id=123&hs=https%3A%2F%2Fwww.111usedcars.ae%2F&hsc=e53fd1fb49e7a057270b8e6968083316&fullwidth=1&t=1&ma=&mo=0&c=new-and-used&pf=&pt=&yf=&yt=&kf=&kt=&b=&co=&ci=&s=&gi=&noi=9&page=1']
    ...
    def parse_data(self, response):
        ...
        item['Year'] = str(arr[2].split('(')[0])
        item['Make'] = str(arr[0])
        item['model'] = arr[1].split('/')[0]
